...
def parser() -> argparse.ArgumentParser:
    result = argparse.ArgumentParser(
        description="Complete focused RD18-P3X-A1C validation and ledger build."
    )
...
def main() -> int:
    ...
    files = [
        "src/spotbot/research/rd18_p3x_a1c_corporate_actions.py",
        "scripts/research/run_rd18_p3x_a1c.py",
        "scripts/research/validate_rd18_p3x_a1c.py",
        "scripts/research/complete_rd18_p3x_a1c.py",
        "tests/research/test_rd18_p3x_a1c.py",
    ]
    commands = [
    ...
    report = json.loads(
        (output / "rd18-p3x-a1c-runtime-report-v1.json").read_text(encoding="utf-8")
    )
    result = {
        "schema_version": "rd18-p3x-a1c-completion-v1",
        "passed": True,
        "commands": records,
        "output_dir": str(output),
        "events": report["events"],
        "segments": report["segments"],
        "terminal_classifications": report["terminal_classifications"],
