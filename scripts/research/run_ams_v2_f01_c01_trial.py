...
EXPECTED_BRANCH = (
    "research/ams-v2-f01-c01-trial-v1"
)
...
REPORT_PATH = (
    ROOT
    / "reports/research/"
    "ams-v2-f01-c01-walk-forward-trial-v1.json"
)

PREFLIGHT_REPORT_PATH = Path(
    r"C:\SIRAJ\Reports"
    r"\ams-v2-f01-wf2022-real-data-structural-preflight.json"
)
...
if REPORT_PATH.exists():
    raise RuntimeError(
        "C01 trial report already exists."
    )
...
if configuration["family_id"] != "AMS-V2-F01":
    raise RuntimeError(
        "C01 is not an F01 configuration."
    )
...
report: dict[str, object] = {
    "schema_version": (
        "ams-v2-f01-c01-walk-forward-trial-v1"
    ),
    "configuration_id": CONFIGURATION_ID,
    "family_id": configuration[
        "family_id"
...
if any(
    ...
    raise RuntimeError(
        "C01 trial event already exists."
    )
