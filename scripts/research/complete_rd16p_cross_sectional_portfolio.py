...
IMPLEMENTATION_SUBJECT: Final = "research(rd16p): add cross-sectional portfolio research"
RESULT_SUBJECT: Final = "research(rd16p): complete cross-sectional portfolio research"

PYTHON_TARGETS: Final = (
    "src/spotbot/research/rd16p_portfolio.py",
    "src/spotbot/research/rd16p_evaluation.py",
    "scripts/research/run_rd16p_cross_sectional_portfolio.py",
    "scripts/research/complete_rd16p_cross_sectional_portfolio.py",
    "tests/research/test_rd16p_cross_sectional_portfolio.py",
)

DATA_OUTPUTS: Final = (
    "data/research/rd16p/variant-registry.csv",
    "data/research/rd16p/variant-summary.csv",
    "data/research/rd16p/component-decisions.csv",
    "data/research/rd16p/cost-stress.csv",
    "data/research/rd16p/selection-audit.csv",
    "data/research/rd16p/routing-summary.csv",
    "data/research/rd16p/annual-performance.csv",
    "data/research/rd16p/bull-window-capture.csv",
    "data/research/rd16p/frozen-input-hashes.json",
    "data/research/rd16p/local-output-manifest-v1.json",
    "data/research/rd16p/output-hashes.json",
    "data/research/rd16p/rd16p-final-report-v1.json",
    "data/research/rd16p/validation-report.json",
)

REPORT_OUTPUTS: Final = (
    "reports/research/rd16p-cross-sectional-portfolio-results-v1.md",
    "reports/research/rd16p-cross-sectional-carry-forward-decisions-v1.md",
    "reports/research/rd16p-selection-capital-causality-audit-v1.md",
)
...
def main() -> None:
    ...
    if missing:
        raise CompletionError(f"Missing RD16-P outputs: {missing}")
    ...
    if git(repo, "status", "--short", "--untracked-files=no"):
        raise CompletionError("Tracked changes remain after RD16-P completion.")

    report_path = repo / "data/research/rd16p/rd16p-final-report-v1.json"
