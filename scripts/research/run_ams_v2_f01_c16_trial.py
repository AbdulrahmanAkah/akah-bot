...
EXPECTED_BRANCH = (
    "research/ams-v2-f01-c16-trial-v1"
)
...
CONFIGURATION_ID = "AMS-V2-F01-C16"
...
REPORT_PATH = (
    ROOT
    / "reports/research/"
    "ams-v2-f01-c16-walk-forward-trial-v1.json"
)
...
expected_accounting = {
    "trials_executed": 15,
    "remaining_authorized_trials": 85,
...
report: dict[str, object] = {
    "schema_version": (
        "ams-v2-f01-c16-walk-forward-trial-v1"
    ),
    "configuration_id": CONFIGURATION_ID,
    "family_id": configuration[
        "family_id"
...
project_after["next_action"] = (
    "EVALUATE_AMS_V2_F01_FAMILY_DECISION"
)
