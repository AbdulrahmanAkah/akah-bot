...
EXPECTED_BRANCH = (
    "research/ams-v2-f01-c11-trial-v1"
)
...
CONFIGURATION_ID = "AMS-V2-F01-C11"
...
REPORT_PATH = (
    ROOT
    / "reports/research/"
    "ams-v2-f01-c11-walk-forward-trial-v1.json"
)
...
expected_accounting = {
    "trials_executed": 10,
    "remaining_authorized_trials": 90,
...
report: dict[str, object] = {
    "schema_version": (
        "ams-v2-f01-c11-walk-forward-trial-v1"
    ),
    "configuration_id": CONFIGURATION_ID,
    "family_id": configuration[
        "family_id"
