...
def decision_from_persistence(
    ...
    if matching:
        return (
            ...
            "RD47_P5_PREREGISTER_ISOLATED_ACTION_MAPPING_WITH_"
    ...
    return (
        "RD47_CROSS_VENUE_CANDLE_GEOMETRY_DIRECT_UTILITY_UNQUALIFIED_NO_RESCUE",
...
def write_outputs(
    ...
    joined.to_csv(
        output_dir / "joined-cross-venue-candle-geometry-rcv-ledger.csv",
        index=False,
        lineterminator="\n",
    )
    ...
    pd.DataFrame(coeff_rows).to_csv(
        output_dir / "cross-venue-candle-geometry-model-coefficients.csv",
        index=False,
        lineterminator="\n",
    )
    ...
    temporal = {
        "schema_version": "rd47-p4-temporal-persistence-qualification-v1",
    ...
    evidence = {
        "schema_version": "rd47-p4-qualified-direct-utility-evidence-freeze-v1",
        "status": "PASS",
    ...
    report = {
        **evidence,
        "schema_version": "rd47-p4-direct-utility-report-v1",
    ...
    (output_dir / "rd47-p4-direct-utility-report-v1.json").write_text(
